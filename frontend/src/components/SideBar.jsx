...
function SideBar() {
  ...
  return (
    <aside className="flex flex-col w-full h-full transition-all duration-200 border-r border-base-300 lg:w-72 md:w-64 sm:w-60">
  {/* Header Section */}
  <div className="w-full p-3 border-b border-base-300">
    <div className="flex flex-wrap items-center justify-between gap-2">
      ...
      <label className="flex flex-wrap items-center gap-2">
        ...
        />
        <span className="text-sm sm:text-xs">online only</span>
      </label>
    </div>
